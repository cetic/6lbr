...
simfilefolder = '../sims/'
simfilepath = simfilefolder+'10x7-grid-15m.csc'
simgen.create_simfile_from_template(simfilepath)

simfile_lines = simgen.read_simfile(simfilepath)


simgen.create_sky_motetype('udp-server','udp-server', 'SkyMote UDP Server', simfile_lines)
simgen.create_sky_motetype('udp-client','udp-client', 'SkyMote UDP Client', simfile_lines)
...
simgen.script_set_timeout(3600000, simfile_lines)
...
simfilepath=simfilefolder+'10x7-grid-12m.csc'
...
simfilepath=simfilefolder+'10x7-grid-22m.csc'
...
simfilepath=simfilefolder+'10x7-grid-25m.csc'
...
simfilepath=simfilefolder+'10x7-grid-32m.csc'
...
simfilepath=simfilefolder+'10x7-grid-42m.csc'
...
simfilepath=simfilefolder+'10x7-grid-52m.csc'
