...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/6lbr/test/coojagen/firmwares/6lbr-demo-delay/6lbr-demo.c</source>
      <commands EXPORT="discard">make 6lbr-demo.sky TARGET=sky WITH_SHELL=1 WITH_WEBSERVER=0 WITH_DELAY_IP=1</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/6lbr/test/coojagen/firmwares/6lbr-demo-delay/6lbr-demo.sky</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <motetype>
      ...
      <commands EXPORT="discard">make 6lbr-demo.sky TARGET=sky WITH_SHELL=1 WITH_WEBSERVER=0 WITH_DELAY_IP=0</commands>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>102.01388888888891</x>
        <y>-23.68055555555556</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>39.37500000000002</x>
        <y>-42.777777777777786</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>17.222222222222236</x>
        <y>-18.333333333333336</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>17.986111111111125</x>
        <y>13.750000000000002</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
      ...
      <interface_config>
        ...
        <history>start6lbr~;</history>
      </interface_config>
      <motetype_identifier>node_delay</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.3090909090909089 0.0 0.0 1.3090909090909089 95.45454545454542 139.0</viewport>
    </plugin_config>
    <width>274</width>
    <z>7</z>
    <height>238</height>
