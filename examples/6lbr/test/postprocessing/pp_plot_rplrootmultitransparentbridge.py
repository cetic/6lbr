...
def scatterplot_RplRootMultiTransparentBridge_500x_vs_delay(results):

    print "scatterplot_RplRootMultiTransparentBridge_500x_vs_delay"
    data = {}
    ...
    ax = fig500x.add_subplot(nrow,ncol,index500x, title="Reach time vs delay", xlim=(0,1200), ylim=(0,800), xlabel=xtitle, ylabel=ytitle)
    for testid in sorted(data.keys()):
    ...
    fig500x.savefig('RplRootMultiTransparentBridge_500x_vs_delay.pdf', format='pdf')
...
def scatterplot_RplRootMultiTransparentBridge_502x_vs_delay(results):

    print "scatterplot_RplRootMultiTransparentBridge_502x_vs_delay"
    data = {}
    ...
    fig500x.savefig('RplRootMultiTransparentBridge_502x_vs_delay.pdf', format='pdf')
