...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>47.560994568193976</x>
        <y>72.56091793471796</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>59.40172120232287</x>
        <y>47.67122725481438</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.138259543866657 0.0 0.0 4.138259543866657 -10.81973968761899 -51.27591115507192</viewport>
    </plugin_config>
    <width>400</width>
    <z>5</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <skin>org.contikios.cooja.plugins.skins.TrafficVisualizerSkin</skin>
      <skin>org.contikios.cooja.plugins.skins.UDGMVisualizerSkin</skin>
      <viewport>12.63757989565634 0.0 0.0 12.63757989565634 -481.8749332031435 -586.7216704294341</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
