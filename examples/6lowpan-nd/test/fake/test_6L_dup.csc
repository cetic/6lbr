...
<simconf>
  ...
  <simulation>
    ...
    <radiomedium>
      ...
      <interference_range>69.0</interference_range>
    ...
    <motetype>
      ...
      <description>Host (fake)</description>
      <source EXPORT="discard">[CONTIKI_DIR]/examples/6lowpan-nd/6l_fake/6lh_fake.c</source>
      <commands EXPORT="discard">make 6lh_fake.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/6lowpan-nd/6l_fake/6lh_fake.sky</firmware>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>80.08166415554784</x>
        <y>46.03537835576318</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>127.83249706908492</x>
        <y>-4.68354225548362</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>51.98291196539914</x>
        <y>72.15593364276626</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>106.7556079733135</x>
        <y>24.05767014784106</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspMoteID
      ...
      <interface_config>
        ...
        <history>netd nc~;netd rt~;netd nc~;</history>
      </interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.5656959549415028 0.0 0.0 1.5656959549415028 63.85317642886221 123.33300316420831</viewport>
    </plugin_config>
    <width>400</width>
    <z>3</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONFIG_DIR]/dup.js</scriptfile>
      <active>true</active>
    </plugin_config>
    <width>600</width>
    <z>0</z>
    <height>700</height>
    <location_x>1103</location_x>
