...
# PIDMAX=0
# PIDMIN=99999999
# for FILENAME in $TYPE/temp*/*.csc
# do
# 	echo "--- $FILENAME ---"
# 	sh $CONTIKI/regression-tests/simexec.sh "true" "$FILENAME" "$CONTIKI" "$TYPE/temp$I/out" "1" &
# 	PIDM=$!
...
# do
# 	echo "------ $FILENAME ------" >> $TYPE/$OUTFILE
# 	cat "$TYPE/temp$I/out.testlog" >> $TYPE/$OUTFILE
# 	I=$(($I+1))
# done;
...
# do
# 	echo "--- $FILENAME ---"
# 	java -Xshare:on -jar $CONTIKI/tools/cooja/dist/cooja.jar -nogui=$FILENAME -contiki=$CONTIKI -random-seed=1 > $TYPE/temp$I.log &
